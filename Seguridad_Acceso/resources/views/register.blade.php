...
<body class="bg-gradient-to-br from-blue-50 via-white to-purple-50 flex items-center justify-center min-h-screen p-4" style="font-family: 'Inter', sans-serif;">
    <div class="w-full max-w-md">
        <div class="bg-white/70 backdrop-blur-lg p-8 rounded-2xl shadow-[0_8px_30px_rgb(0,0,0,0.12)] border border-white/60">
            <div class="mb-8 text-center">
                <h2 class="text-3xl font-semibold bg-gradient-to-r from-blue-600 to-purple-600 bg-clip-text text-transparent">Registro</h2>
                <p class="text-gray-500 mt-2">Crea tu cuenta para continuar</p>
            </div>
            ...
            <form method="POST" action="{{ route('register') }}" class="space-y-6" onsubmit="return validateForm()">
                ...
                <div class="space-y-2">
                    ...
                    <p id="passwordConfirmError" class="hidden text-sm text-red-500 mt-1"></p>
                </div>
